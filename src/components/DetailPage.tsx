            ...
            <div className="py-8 text-left lg:py-16 lg:px-12">
                <div className="flex justify-between">
                    <div className="flex flex-col justify-start">
                        ...
                        <p className="mb-8 text-lg font-normal text-blue-700 lg:text-base text-left">{data.fullName}</p>
                    </div>
                    <div className="flex justify-start">
                        <Image className="w-40 h-40 rounded" src={data.image} alt="profile-image" height={1000} width={1000} />
                    </div>
                </div>
